...
class ProbingClassifier(models.Model):
    ...
    def call(self, inputs: tf.Tensor, training: bool =False) -> tf.Tensor:
        ...
        """
        dic = self._pretrained_model(inputs, training)
        layer_representations = dic['layer_representations']
        layer_representations = tf.unstack(layer_representations, axis=1)
        classification_vector = layer_representations[self._layer_num - 1]
